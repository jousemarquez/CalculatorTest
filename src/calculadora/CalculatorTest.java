...
class CalculatorTest {
    ...
    public void multiplyEquivalence1() {
        ...
        double result = instance.multiply(10.0,25.0);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void multiplyLimitsValues1() {
        ...
        double result = instance.multiply(717229.82,67.28);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void multiplyLimitsValues2() {
        ...
        double result = instance.multiply(-717229.82,230.21);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void multiplyLimitsValues3() {
        ...
        Calculator instance = new Calculator();
        double expectedResult = 0.0;
        double result = instance.multiply(0.0,0.0);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void multiplyRandomValues1() {
        ...
        double result = instance.multiply(43.21,10.10);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void multiplyRandomValues2() {
        ...
        double result = instance.multiply(50.70,-78.00);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void multiplyRandomValues3() {
        ...
        double result = instance.multiply(0.90,432.00);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void divideEquivalence1() {
        ...
        double result = instance.divide(10.0,25.0);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void divideLimitsValues1() {
        ...
        double result = instance.divide(717229.82,67.28);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void divideLimitsValues2() {
        ...
        double result = instance.divide(-717229.82,230.21);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void divideLimitsValues3() {
        ...
        double result = instance.divide(503.0,0.0);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void divideRandomValues1() {
        ...
        double result = instance.divide(43.21,10.10);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void divideRandomValues2() {
        ...
        double result = instance.divide(50.70,-78.00);
        assertArrayEquals(expectedResult,result,DELTA);
    }
    ...
    public void divideRandomValues3() {
        ...
        double result = instance.divide(0.90,432.00);
        assertArrayEquals(expectedResult,result,DELTA);
    }
}